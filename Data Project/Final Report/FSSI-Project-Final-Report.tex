...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth,height=\textheight]{Plotly example.png}
...
\hypertarget{social-service-sector-growth-analysis}{%
\subsubsection{Social service sector growth Analysis}\label{social-service-sector-growth-analysis}}
...
\hypertarget{workforce-composition-analysis}{%
\subsubsection{Workforce Composition Analysis}\label{workforce-composition-analysis}}
...
\hypertarget{sector-funding-analysis}{%
\subsubsection{Sector Funding Analysis}\label{sector-funding-analysis}}
...
\hypertarget{financial-health-of-sector-analysis}{%
\subsubsection{Financial Health of Sector Analysis}\label{financial-health-of-sector-analysis}}
...
\NormalTok{VCOSS_ACNC_}\DecValTok{16}\NormalTok{ <-}\StringTok{ }\NormalTok{VCOSS_ACNC_}\DecValTok{16}\NormalTok{[}\KeywordTok{which}\NormalTok{(}\OperatorTok{!}\NormalTok{(VCOSS_ACNC_}\DecValTok{16}\OperatorTok{$}\NormalTok{abn }\OperatorTok{%in%}\StringTok{ }\NormalTok{Invalid_ABNs_}\DecValTok{16}\OperatorTok{$}\NormalTok{abn)), ]}

\NormalTok{VCOSS_ACNC_}\DecValTok{17}\NormalTok{ <-}\StringTok{ }\NormalTok{VCOSS_ACNC_}\DecValTok{17}\NormalTok{[}\KeywordTok{which}\NormalTok{(}\OperatorTok{!}\NormalTok{(VCOSS_ACNC_}\DecValTok{17}\OperatorTok{$}\NormalTok{abn }\OperatorTok{%in%}\StringTok{ }\NormalTok{Invalid_ABNs_}\DecValTok{17}\OperatorTok{$}\NormalTok{abn)), ]}
\end{Highlighting}
\end{Shaded}
