...
\begin{tabular}{|>{}l|>{\raggedright\arraybackslash}p{80mm}|>{\raggedright\arraybackslash}p{40mm}|}
\hline
...
\cline{2-3}
\rowcolor{gray!6}  \multirow{-9}{*}{\raggedright\arraybackslash Project Proposal} & 7 Appendices & Xuejiao Zhou and Ben Cole\\
\cline{1-3}
Web Report & Foreword & Ben Cole, Xuejiao Zhou\\
\hline
\end{tabular}
\endgroup{}
\end{table}
