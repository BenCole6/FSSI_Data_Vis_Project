...
From 2016 to 2017, the dominant staff type was volunteer. The number of casual staff was the smallest in both year of 2016 and  year of 2017 compared with other staff types. Large charities had the largest number of staffs,followed by small charities and medium charities. 
A slight decreasing by 6.4% in numbers of volunteers was seen in large charities in the period of 2016 to 2017 , from 57,351 to 54,266. There were changes in the number of part-time employees and the number of full-time employees as well. The number of part-time employees was decreased from 15,220 to 14,570 (0.2% drop).

### Total Staff by Sector {.tabset .tabset-pills}
...
gg_SocServ_DebtSurplus <- ggplot(SocServ_DebtSurplus_MainAct_1617_long,
  ...
  scale_color_manual("Budget Status",
                     values = FSSIQualPal(3)) +
  ggtitle("Count of Social Services Charities by Budget Status, 2016 - 2017") +
  theme_minimal()
...
### Percent of Charities in Deficit
...
DebtSurplus_1617_long <- rbind(Other_DebtSurplus_MainAct_1617_long, SocServ_DebtSurplus_MainAct_1617_long)

DebtSurplus_1617_long <- mutate(group_by(DebtSurplus_1617_long,
                                         main_activity, Year),
                                proportion = (count / sum(count, na.rm = TRUE)))

gg_DebtSurplus_1617_prop <- ggplot(DebtSurplus_1617_long) +
  geom_bar(aes(x = proportion,
...
ggplotly(gg_DebtSurplus_1617_prop,
         tooltip = "text") %>% 
