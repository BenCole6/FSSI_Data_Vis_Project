...
plot_ly(data = filter(Volunteers_PaidStaff_678_long,
        ...
        marker = list(colors = c("rgb(84, 144, 65))",
                      ...
                      line = list(color = "#cecece",
                                  width = 0.85))) %>% 
  layout(title = list(text = "Volunteer Workforce Share for Social Service, 2016 to 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         font = list(family = FSSIfont,
...
ggplotly(gg_SocServ_DebtSurplus,
         tooltip = "text") %>% 
  layout(title = list(text = "Count of Social Service Charities by Budget Status, 2016 - 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         font = list(family = FSSIfont,
...
subplot(pl_SocServ_DebtSurplus_CharSize_678,
        ...
        nrows = 2,
        margin = 0.066) %>% 
  layout(title = list(text = "Social Service Budget status by Charity Size, 2016 to 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         legend = list(title = list(text = "Budget status",
...
ggplotly(gg_Grants_InOut_MainAct_678,
         tooltip = "text") %>% 
  layout(title = list(text = "Grant Use for Social Service, 2016 to 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         font = list(family = FSSIfont,
