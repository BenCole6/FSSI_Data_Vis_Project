...
Charities operating in the social services sector comprised more than one out of every five charities operating in Victoria in 2016 and 2017. In 2016 this was `r comma(SocServ16, 1)` charities, which decreased slightly in 2017 to `r comma(SocServ17, 1)` (`r percent(SocServ16 / TotalCount16, 0.1)` and `r percent(SocServ17 / TotalCount17, 0.1)` of total charities, respectively). In 2018 the number of social services charities decreased again to `r comma(SocServ18, 1)` (`r percent(SocServ18 / TotalCount18, 0.1)`), which was in line with a decrease across all charities (`r comma(TotalCount18, 1)` total charities).   
...
ggplotly(gg_Sum_VIC_SocServ_678,
  ...
  layout(font = list(family = FSSIfont,
                     size = 12),
         title = list(text = "Number of Social Services Charities, 2016 to 2018",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
...
ggplotly(gg_SocServ_Staff_MainAct_678,
         tooltip = "text") %>% 
  layout(title = list(text = "Changes in Staff Counts by Work Loading in Social Services, 2016 to 2018",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
...
ggplotly(gg_SocServ_Volunteers_PaidStaff_678,
  ...
  layout(legend = list(title = list(text = "Charity size",
                       ...
                       itemclick = "toggleothers",
                       itemdoubleclick = "toggle"),
         title = list(text = "Volunteers and Paid Staff Working for Social Services, 2016 to 2018",
                      xref = "canvas",
                      x = 0.1),
         margin = list(t = 50,
                       b = 10,
...
subplot(pl_Other_Revenue678, pl_SocServ_Revenue678,
        nrows = 1, shareY = TRUE) %>% 
  layout(title = list(text = "Victorian Social Services Revenue Sources, 2016 to 2018",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
...
subplot(pl_SocServ_DebtSurplus_CharSize_678,
        ...
        nrows = 2,
        margin = 0.066) %>% 
  layout(title = list(text = "Social Services Budget status by Charity Size, 2016 to 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         legend = list(title = list(text = "Budget status",
