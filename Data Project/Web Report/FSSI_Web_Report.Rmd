...
DebtSurplus_MainAct_CharSize_1617 <- rbind(DebtSurplus_MainAct_CharSize_16,
                                           DebtSurplus_MainAct_CharSize_17)

DebtSurplus_MainAct_CharSize_1617_long <- pivot_longer(DebtSurplus_MainAct_CharSize_1617,
                                                       cols = c(deficit,
                                                                balanced,
                                                                surplus),
                                                       names_to = "budget_status",
...
DebtSurplus_MainAct_CharSize_1617_long <- mutate(group_by(DebtSurplus_MainAct_CharSize_1617_long,
                                                          main_activity, charity_size, Year),
                                                 proportion = (count / sum(count)))

SocServ_DebtSurplus_CharSize_1617 <- filter(DebtSurplus_MainAct_CharSize_1617_long,
                                            str_detect(main_activity,
                                                       regex("social services",
                                                             ignore_case = TRUE)))
...
gg_SocServ_DebtSurplus_CharSize_1617 <- ggplot(SocServ_DebtSurplus_CharSize_1617) +
...
pl_SocServ_DebtSurplus_CharSize_1617 <- ggplotly(gg_SocServ_DebtSurplus_CharSize_1617,
                                                 tooltip = "text")

gg_SocServ_DebtSurplus_CharSize_1617_prop <- ggplot(SocServ_DebtSurplus_CharSize_1617) +
  geom_bar(aes(x = proportion,
               y = charity_size,
               fill = budget_status,
               text = paste(sep = "\n",
...
pl_SocServ_DebtSurplus_CharSize_1617_prop <- ggplotly(gg_SocServ_DebtSurplus_CharSize_1617_prop,
                                                      tooltip = "text")

subplot(pl_SocServ_DebtSurplus_CharSize_1617,
        pl_SocServ_DebtSurplus_CharSize_1617_prop,
        nrows = 2,
        margin = 0.066) %>% 
