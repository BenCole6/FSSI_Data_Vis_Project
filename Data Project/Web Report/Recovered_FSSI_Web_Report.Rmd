...
FSSIQualPal <- function(n_colours){
  ...
  palette = c("#7ebaba", "#927bad", "#d2d282", "grey20", "#4953ff",
...
gg_Sum_VIC_SocServ_1617 <- ggplot(Sum_VIC_SocServ_1617,
  ...
  scale_x_discrete("Year",
                   expand = c(0.05, 0.05)) +
  ggtitle("Number of Social Services Charities, 2016 to 2017") +
...
subplot(pl_Other_Revenue1617, pl_SocServ_Revenue1617,
  ...
  layout(xaxis = list(title = list(text = "Year\nOther Sectors",
         ...
         xaxis2 = list(title = list(text = "Year\nSocial Services",
                                   font = list(size = 13))),
         legend = list(temclick = "toggleothers",
                       itemdoubleclick = "toggle"))
...
pl_SocServ_Revenue <- plot_ly(data = SocServ_Revenue1617_long,
                             x = ~revenue_amount,
                             y = ~str_clean_wrap(main_activity, 36),
                             text = ~revenue_proportion,
                             color = ~str_cleaner(revenue_source),
...
subplot(pl_OtherRevenue, pl_SocServ_Revenue,
        nrows = 2,
...
gg_Other_Revenue_prop <- ggplot(filter(Revenue1617_long,
  ...
  geom_bar(aes(x = revenue_proportion,
               ...
               text = paste(sep = "\n",
                            str_clean_wrap(main_activity, 28),
                            str_clean_wrap(revenue_source, 28),
...
### Social Services Staff by Employment Type {.tabset .tabset-pills}
...
gg_SocServ_Staff_MainAct_1617 <- ggplot(SocServ_Staff_MainAct_1617,
  ...
  #                scales = "free_y",
  #                ncol = 3) +
  ggtitle("Changes in Staff Counts by Work Loading in Social Services, 2016 to 2017") +
  theme_minimal() +
...
gg_SocServ_Staff_CharSize_1617 <- ggplot(SocServ_Staff_CharSize_1617) +
  geom_bar(aes(x = employee_count,
               ...
               text = paste(sep = "\n",
                            ...
                            paste(percent(proportion, 0.1), "of all staff"))),
           stat = "identity") +
  facet_rep_wrap(~Year) +
...
ggplotly(gg_SocServ_Volunteers_PaidStaff_1617,
         tooltip = "text") %>% 
  add_annotations(text = "equal paid and volunteer staff",
         textangle = -31.55, opacity = 0.5,
         showarrow = FALSE,
         xref = "x", x = 20000,
         yref = "y", y = 22500) %>% 
...
plot_ly(data = filter(Volunteers_PaidStaff_1617_long,
        ...
        hovertemplate = paste(sep = "\n",
                                ...
                                activity[1],
                                "<extra></extra>"),
        marker = list(colors = c("rgb(126, 186, 186)",
                                 "rgb(210, 210, 139)"),
                      line = list(color = "#cecece",
                                  width = 0.85))) %>% 
  layout(title = list(text = "Volunteer Workforce Percentage for Social Services, 2016 to 2017",
                      standoff = 10,
                      xref = "canvas",
                      x = 0.1),
         font = list(family = FSSIfont,
...
SocServ_DebtSurplus_MainAct_16 <- summarise(group_by(filter(VCOSS_ACNC_16,
                                                            str_detect(main_activity_2016,
                                                                       regex("social services", 
                                                                             ignore_case = TRUE))),
                                                     main_activity = main_activity_2016),
                                            net_deficit = sum(net_surplus_deficit_2016 < 0),
...
SocServ_DebtSurplus_MainAct_17 <- summarise(group_by(filter(VCOSS_ACNC_17,
                                                            str_detect(main_activity,
                                                                       regex("social services", 
                                                                             ignore_case = TRUE))),
                                                     main_activity),
                                            net_deficit = sum(net_surplus_deficit_2017 < 0),
...
gg_SocServ_DebtSurplus <- ggplot(SocServ_DebtSurplus_MainAct_1617_long,
  ...
  scale_y_continuous("Number of Charities",
                     labels = comma,
                     limits = c(0, NA)) +
  scale_color_manual("Budget Status",
                     values = FSSIQualPal(6)[4:6]) +
  ggtitle("Number of Social Services Charities by Budget Status, 2016 - 2017") +
  theme_minimal()
...
### Percent of Charities in Deficit by Sector
...
gg_Other_DebtSurplus_1617_prop <- ggplot(Other_DebtSurplus_MainAct_1617_long) +
  geom_bar(aes(x = proportion,
               ...
               text = paste(sep = "\n",
                            ...
                            paste(comma(count, 1), "charities"),
                            paste("Budget in", str_cleaner(budget_status)))),
           stat = "identity",
           show.legend = TRUE) +
  scale_fill_manual("",
                    values = FSSIQualPal(3)) +
  ...
  scale_x_continuous(" \nPercent",
                     labels = percent) +
  scale_y_discrete("") +
  ggtitle("Percentage of Charities by Budget Status and Sector") +
  theme_minimal()  +
  theme(panel.spacing.x = unit(1, "cm"),
        strip.text = element_text(colour = NA))

pl_Other_DebtSurplus_1617_prop <- ggplotly(gg_Other_DebtSurplus_1617_prop,
                                           tooltip = "text") %>% 
  layout(showlegend = TRUE,
         font = list(family = FSSIfont,
                     size = 12),
...
gg_SocServ_DebtSurplus_1617_prop <- ggplot(SocServ_DebtSurplus_MainAct_1617_long) +
  geom_bar(aes(x = proportion,
               y = fct_rev(str_clean_wrap(main_activity, 28)),
               fill = fct_rev(str_cleaner(budget_status)),
               text = paste(sep = "\n",
...
pl_SocServ_DebtSurplus_1617_prop <- ggplotly(gg_SocServ_DebtSurplus_1617_prop,
                                             tooltip = "text") %>% 
  layout(showlegend = TRUE,
         font = list(family = FSSIfont,
                     size = 12),
...
subplot(pl_Other_DebtSurplus_1617_prop, pl_SocServ_DebtSurplus_1617_prop,
        nrows = 2,
        heights = c(10/11, 1/11),
        shareX = TRUE,
        margin = 0) %>% 
  layout(legend = list(title = list(text = "Revenue Source"),
                       ...
                       x = 1.25,
                       y = 1,
                       traceorder = "reversed+grouped"), # doesn't seem to work
         title = list(text = "Budget Status by Main Activity",
                      pad = list(b = 10),
                      xref = "canvas",
                      x = 0.1),
         margin = list(t = 66),
...
### Budget Status and Charity Size for Social Services

```{r echo=FALSE, message=FALSE, warning=FALSE}

SocServ_BudgetStatus_CharSize_16 <- summarise(group_by(filter(VCOSS_ACNC_16,
                                                              str_detect(main_activity_2016,
                                                                         regex("social services", ignore_case = TRUE))),
                                                       charity_size),
                                              net_deficit = sum(net_surplus_deficit_2016 < 0),
...
SocServ_BudgetStatus_CharSize_16_long <- pivot_longer(SocServ_BudgetStatus_CharSize_16,
                                                      cols = c(net_deficit,
                                                               net_even,
                                                               net_surplus),
                                                      names_to = "budget_status",
                                                      values_to = "number_of_charities")

SocServ_BudgetStatus_CharSize_16_long$Year <- 2016

SocServ_BudgetStatus_CharSize_17 <- summarise(group_by(filter(VCOSS_ACNC_17,
                                                              str_detect(main_activity,
                                                                         regex("social services", ignore_case = TRUE))),
                                                       charity_size),
                                              net_deficit = sum(net_surplus_deficit_2017 < 0),
...
SocServ_BudgetStatus_CharSize_17_long <- pivot_longer(SocServ_BudgetStatus_CharSize_17,
                                                      cols = c(net_deficit,
                                                               net_even,
                                                               net_surplus),
                                                      names_to = "budget_status",
...
SocServ_BudgetStatus_CharSize_17_long$Year <- 2017

SocServ_BudgetStatus_CharSize_1617 <- rbind(SocServ_BudgetStatus_CharSize_16_long,
                                            SocServ_BudgetStatus_CharSize_17_long)

SocServ_BudgetStatus_CharSize_1617 <- mutate(group_by(SocServ_BudgetStatus_CharSize_1617,
                                                      charity_size, Year),
                                             proportion = (number_of_charities / sum(number_of_charities)))

gg_SocServ_BudgetStatus_CharSize <- ggplot(SocServ_BudgetStatus_CharSize_1617) +
  geom_bar(aes(x = number_of_charities,
               y = charity_size,
               fill = fct_rev(str_cleaner(budget_status)),
               text = paste(sep = "\n",
                            paste(comma(number_of_charities, 1),
                                  str_cleaner(charity_size),
                                  "charities"),
                            paste("with budget in", str_cleaner(budget_status)),
                            paste0("(", percent(proportion, 0.1),
                                   " of all ",
                                   str_cleaner(charity_size),
                                   " charities)"))),
           stat = "identity") +
...
pl_SocServ_BudgetStatus_CharSize <- ggplotly(gg_SocServ_BudgetStatus_CharSize,
                                             tooltip = "text")


gg_SocServ_BudgetStatus_CharSize_prop <- ggplot(SocServ_BudgetStatus_CharSize_1617) +
  geom_bar(aes(x = proportion,
               y = charity_size,
               fill = fct_rev(str_cleaner(budget_status)),
               text = paste(sep = "\n",
                            paste(percent(proportion, 0.1), "of",
                                  str_cleaner(charity_size),
                                  "charities with budget in"),
                            str_cleaner(budget_status),
                            paste0("(", comma(number_of_charities),
                                   " charities)"))),
           stat = "identity") +
  facet_wrap(~Year) +
  scale_fill_manual("",
...
pl_SocServ_BudgetStatus_CharSize_prop <- ggplotly(gg_SocServ_BudgetStatus_CharSize_prop,
                                                  tooltip = "text")

subplot(pl_SocServ_BudgetStatus_CharSize, pl_SocServ_BudgetStatus_CharSize_prop,
        nrows = 2, shareY = TRUE,
        margin = 0.066) %>% 
  layout(title = list(text = "Social Services Budget Status by Charity Size, 2016 to 2017",
         ...
         xaxis2 = list(title = list(text = "Number of Charities",
                                   standoff = 10)),
         xaxis3 = list(title = list(text = "Percentage of Charities",
                                   standoff = 10)),
         xaxis4 = list(title = list(text = "Percentage of Charities",
                                   standoff = 10)),
         font = list(family = FSSIfont,
                     size = 12))
...
gg_Grants_InOut_MainAct_1617 <- ggplot(Grants_InOut_MainAct_1617_long,
  ...
  scale_y_continuous("Grant Amount",
                     labels = dollar_format(scale = 0.000001,
                                            suffix = "m")) +
  scale_color_manual("Grant use",
                     values = FSSIQualPal(2)) +
  ggtitle("Grant Use for Social Services, 2016 to 2017") +
  theme_minimal()
...
gg_Grants_CharSize_1617 <- ggplot(Grants_CharSize_1617_prop) +
  ...
  ggtitle("Grants by Country Use and Charity Size") +
  theme_minimal() +
...
gg_Grants_CharSize_1617_prop <- ggplot(Grants_CharSize_1617_prop) +
  ...
  scale_x_continuous(" \nPercentage of Grants",
                     labels = percent) +
  scale_y_discrete(" \nCharity Size") +
  ggtitle("Percentage of Grants by Country Use and Charity Size") +
  theme_minimal() +
  theme(panel.spacing.y = unit(2, "cm"),
        axis.ticks.length.x = unit(2, "mm"))
...
See [the ABN website](https://abr.business.gov.au/Help/AbnFormat) for more on how invalid ABNs can be identified.
...
gg_Sum_VIC_Others_1617 <- ggplot(Sum_VIC_Others_1617,
  ...
  scale_x_discrete(" \nYear",
                   expand = c(0.05, 0.05)) +
  ggtitle("Number of Charities in Other Sectors, 2016 to 2017") +
  scale_color_manual("Charity Size",
...
ggplotly(gg_Other_Staff_MainAct_1617,
  ...
  layout(font = list(family = FSSIfont,
         ...
         legend = list(orientation = "v",
                       ...
                       xanchor = "right",
                       x = 1.25,
                       title = list(text = "Employment Type")))
...
gg_Other_DebtSurplus <- ggplot(Other_DebtSurplus_MainAct_1617_long,
  ...
  scale_color_manual("",
                     values = FSSIQualPal(3)) +
  ggtitle("Count of Other Sector Charities by Budget Status, 2016 - 2017") +
  theme_minimal() +
  theme(panel.spacing.y = unit(2, "cm"),
        panel.spacing.x = unit(1, "cm"),
        axis.ticks.length.x = unit(2, "mm"))
...
gg_Grants_InOut_MainAct_1617 <- ggplot(Grants_InOut_MainAct_1617_long,
  ...
  scale_color_manual("",
                     values = FSSIQualPal(2)) +
  ggtitle("Grant Use for Other Sectors, 2016 to 2017") +
  theme_minimal() +
  theme(panel.spacing.y = unit(2, "cm"),
        panel.spacing.x = unit(1, "cm"),
        axis.ticks.length.x = unit(2, "mm"),
